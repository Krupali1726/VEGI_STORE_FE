    ...
    const handleShow = async () => {
        try {
            ...
            setTimeout(() => {
                ...
                if (typeof setIsCheckoutPage === 'function') {
                        ...
                        <Form>
                            <Row>
                                ...
                                <Col md={7}>
                                    ...
                                    <label className={`g_method_border p-2 d-flex g_radio-wrapper align-items-center w-96 ${selected === "Cod" ? "selected-border" : ""}`}>
                                        <input
                                            type="radio"
                                            id="Cod"
                                            name="payment"
                                    ...
                                    <label className={`g_method_border g_radio-wrapper mt-4 p-2  align-items-center  w-100 ${selected === "Card" ? "selected-border" : ""}`}>
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            <div className='d-flex flex-wrap'>
                                                ...
                                                <Image src={discover} className='ms-2'></Image>
                                            </div>
                                        </div>
                                        {selected === "Card" && (
                                            <>
                                    ...
                                    <label className={`g_method_border g_radio-wrapper mt-4 p-2  align-items-center w-100 ${selected === "Upi" ? "selected-border" : ""}`}>
                                        <div className='d-flex justify-content-between'>
                                            <div className='d-flex align-items-center'>
                                                <input
                                                    type="radio"
                                    ...
                                    <label className={`g_method_border g_radio-wrapper mt-4 p-2  align-items-center w-100 ${selected === "Net Banking" ? "selected-border" : ""}`}>
                                        <div className='d-flex justify-content-between'>
                                            <div className='d-flex align-items-center'>
                                                <input
                                                    type="radio"
                                ...
                                <Col md={5} >
                                    <div className='g_checkout_border mt-4'>
