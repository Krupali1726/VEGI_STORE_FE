...
export default function LogoHeader({
  ...
  const handleCartClick = () => {
    ...
    navigate('/cart'); // Add navigation to cart page
    ...
    <div className={`a_logomainheader a_header_container sticky-top ${scrolled ? 'shadow-sm' : ''}`} >
      <nav className={`navbar navbar-expand-lg pb-0`}>
        <div className="container-fluid d-flex align-items-center justify-content-between">
          {/* <a className="navbar-brand text-success fw-bold fs-2 me-4" href="/">
            LOGO
          </a> */}
          <Link
            to="/"
            className="navbar-brand text-success fw-bold fs-2 me-4"
            onClick={() => localStorage.removeItem("activePage")}
          >
            LOGO
          </Link>
          ...
          <div className="d-none d-sm-flex flex-grow-1 ms-2  me-3 position-relative" ref={searchRef}>
