        ...
        <div className="a_col-9">
          <div className="a_header d-flex flex-wrap justify-content-between align-items-center">
            ...
            <Link
              ...
              <Link
                to="/profile"
                className={`text-decoration-none ${window.location.pathname === "/profile"
                  ? "text-dark fw-bold"
                  : "text-secondary"
                  }`}
              >
                    ...
                    {({ values, setFieldValue, resetForm }) => (
                      <FormikForm>
                          ...
                          <div className="row">
                            ...
                            <div className="mb-3 gap-4 d-flex align-items-center ">
                              <div className="me-3">
                                ...
                                <div className="d-flex gap-2 z_red_res">
                        ...
                        <Modal.Footer className="border-0 gap-3 d-flex justify-content-center">
                          <Button className="x_btn x_btn-cancel px-4" onClick={() => setShowFirstModal(false)} >
                            Cancel
                          </Button>
                          <Button type="submit" variant="success" className="x_btn x_btn-reset">
